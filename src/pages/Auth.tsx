...
//       const data = await authApi.signin({ email: loginEmail, password: loginPassword });
//       login(data.token); 
//       toast({ title: "Hello", description: "Done" });
//       navigate("/feed"); 
//     } catch (err: any) {
//       const message = err?.response?.data?.message || err.message || "Wrong";
//       toast({ title: "Wronr", description: message, variant: "destructive" });
//     } finally {
//       setLoginLoading(false);
//     }
//   };
...
//     e.preventDefault();
//     if (regPassword !== regRePassword) {
//       toast({ title: "Wrong", description: "password not match", variant: "destructive" });
//       return;
//     }
//     setRegLoading(true);
//     try {
